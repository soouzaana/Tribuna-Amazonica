...
<?php else : ?>
  ...
  <!-- Variante Default -->
  <section class="block block-instagram bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-12 p-3">
    <div class="max-w-xl mx-auto text-center">

      <div class="inline-flex items-center justify-center bg-gradient-to-br from-purple-600 to-pink-600 rounded-full mb-4 p-4">
      ...
      <a href="<?= esc_url($instagram_url); ?>"
        target="_blank"
        rel="noopener noreferrer"
        class="inline-flex items-center p-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full font-semibold hover:from-purple-700 hover:to-pink-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105">
